...
def crawl(
    ...
    source: str = typer.Option(
        "all",
        help="Data source (CN: cdc_weekly/nhc/pubmed/all; US: nndss_api/all; JP: jp_weekly/local; AU/NZ: all; TW: nidss_open_data; HK: chp_notifiable; BR: sinan_datasus or comma-separated SINAN prefixes; KR: kdca_open_api or portal/KOSIS download file)",
    ),
