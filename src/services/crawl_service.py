...
class CrawlService:
    ...
    async def execute(
        ...
        from src.data.processors import AUMonthlyUpdater, DataProcessor, JPWeeklyUpdater, USWeeklyUpdater, NZMonthlyUpdater, TWMonthlyUpdater, BRMonthlyUpdater, KRMonthlyUpdater, HKMonthlyUpdater

        if country_code not in ("CN", "US", "JP", "AU", "NZ", "TW", "HK", "BR", "KR"):
            raise ValueError(f"Unsupported country: {country_code}. Available: CN, US, JP, AU, NZ, TW, HK, BR, KR")
